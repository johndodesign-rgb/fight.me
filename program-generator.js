      ...
      A: () => {
        ...
        return {
          ...
          exercises: [
            ...
            iso1  && { ...iso1,  role: 'Isolation', sets: '2', repRange: `${iso1.repRange} · failure` },
            iso2  && { ...iso2,  role: 'Isolation', sets: '2', repRange: `${iso2.repRange} · failure` },
          ].filter(Boolean)
        };
      },
      ...
      B: () => {
        ...
        return {
          ...
          exercises: [
            ...
            iso1   && { ...iso1, role: 'Isolation', sets: '2', repRange: `${iso1?.repRange || '12–15'} · failure` },
          ].filter(Boolean)
        };
      },
